...
deliverables/
  README.md                       Capability overview and setup (this file)
  PLAN.md                         Implementation plan
  STATUS.md                       Project status
  Architecture-Design.md          System architecture
  Architecture_Review_Board.md    ARB checklist (approved)
  api-schema.yaml                 OpenAPI specification
  MCP-Selection.md                MCP server selection
  PR-Document.md                  Pull request documentation
  SDLR-DELIVERABLE.md             SDLR loop evidence
  Development-Logs.md             Development session logs
  CodeRabbit-Resolution.md        Code review resolutions
